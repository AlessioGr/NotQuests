...
public class SpeakerSelector<C> extends CommandArgument<C, Speaker> { //0 = Quest
    ...
    protected SpeakerSelector(
        ...
        super(required, name, new SpeakerSelector.SpeakerParser<>(main, conversationContext), defaultValue, Speaker.class, suggestionsProvider);
    }


    public static <C> SpeakerSelector.@NonNull Builder<C> newBuilder(final @NonNull String name, final NotQuests main, final String conversationContext) {
