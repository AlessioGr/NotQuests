...
//Copy-and-pasted from https://github.com/Incendo/cloud/blob/1.7.0-dev/cloud-core/src/main/java/cloud/commandframework/arguments/standard/DurationArgument.java
