...
public class ItemStackSelection {
    ...
    public void addMaterialName(final String materialName) {
        ...
        this.materials.add(
                Material.getMaterial(materialName.toLowerCase(Locale.ROOT))
        );
    }
    ...
    public void loadFromFileConfiguration(FileConfiguration configuration, String initialPath) {
        ...
        if(configuration.contains(initialPath + ".nqItems")){
            final ConfigurationSection nqItemSection = configuration.getConfigurationSection(initialPath + ".nqItems");
        ...
        if(configuration.contains(initialPath + ".itemStacks")){
            final ConfigurationSection itemStacksSection = configuration.getConfigurationSection(initialPath + ".itemStacks");
        ...
        if(configuration.contains(initialPath + ".materials")){
            final ConfigurationSection materialsSection = configuration.getConfigurationSection(initialPath + ".materials");
    ...
    public final String getAllMaterialsListed(){
        ...
        return materialsString.length() >= 2 ? materialsString.substring(2) : materialsString.toString();
    }
