...
public final class UpdateChecker {
    ...
    private UpdateChecker(@NotNull NotQuests main, int pluginID, @NotNull VersionScheme versionScheme) {
        this.main = main;
    ...
    public CompletableFuture<UpdateResult> requestUpdateCheck() {
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                String pluginVersion = main.getMain().getDescription().getVersion();
     ...
     */
    @NotNull
    public static UpdateChecker init(@NotNull NotQuests main, int pluginID, @NotNull VersionScheme versionScheme) {
        Preconditions.checkArgument(main.getMain() != null, "Plugin cannot be null");
        Preconditions.checkArgument(pluginID > 0, "Plugin ID must be greater than 0");
        Preconditions.checkArgument(versionScheme != null, "null version schemes are unsupported");

        return (instance == null) ? instance = new UpdateChecker(main, pluginID, versionScheme) : instance;
    }
     ...
     */
    @NotNull
    public static UpdateChecker init(@NotNull NotQuests main, int pluginID) {
        return init(main, pluginID, VERSION_SCHEME_DECIMAL);
    }
    ...
    public final class UpdateResult {
        ...
        private UpdateResult(@NotNull UpdateReason reason) {
            ...
            this.reason = reason;
            this.newestVersion = main.getMain().getDescription().getVersion();
        }
