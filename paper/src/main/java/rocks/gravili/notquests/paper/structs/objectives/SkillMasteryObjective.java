...
public class SkillMasteryObjective extends Objective {
    ...
    public static void handleCommands(
        ...
        addObjectiveBuilder =
                addObjectiveBuilder
                        ...
                        argument(StringArgument.<CommandSender>newBuilder("Skill to master").withSuggestionsProvider((context, lastString) -> {
                            ...
                            return completions;
                        }).build(), ArgumentDescription.of("Skill to master"))
    ...
    public String getTaskDescriptionInternal(
        ...
        return main.getLanguageManager()
                .getString(
                        "chat.objectives.taskDescription.masterSkill.base",
                        questPlayer,
                        activeObjective,
                        Map.of("%SKILLTOMASTER%", getSkillToMaster()));
    }
