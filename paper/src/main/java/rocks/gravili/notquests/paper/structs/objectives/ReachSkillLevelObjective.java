...
public class ReachSkillLevelObjective extends Objective {
    ...
    public String getTaskDescriptionInternal(
        ...
        return main.getLanguageManager()
                .getString(
                        ...
                        questPlayer,
                        activeObjective,
                        Map.of("%LEVELTOREACH%", getSkillToLevelUp()));
    }
    ...
    public void save(FileConfiguration configuration, String initialPath) {
        configuration.set(initialPath + ".specifics.levelToReach", getSkillToLevelUp());
    ...
    public void load(FileConfiguration configuration, String initialPath) {
        mobToKillType = configuration.getString(initialPath + ".specifics.levelToReach");
