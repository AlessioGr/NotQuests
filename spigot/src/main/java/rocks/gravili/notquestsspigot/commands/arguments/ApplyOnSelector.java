...
public class ApplyOnSelector<C> extends CommandArgument<C, Integer> { //0 = Quest
    ...
    protected ApplyOnSelector(
        ...
        super(required, name, new ApplyOnsParser<>(main, questContext), defaultValue, Integer.class, suggestionsProvider);
    }


    public static @NonNull <C> Builder<C> newBuilder(final @NonNull String name, final NotQuests main, final String questContext) {
        return new Builder<>(name, main, questContext);
    }
