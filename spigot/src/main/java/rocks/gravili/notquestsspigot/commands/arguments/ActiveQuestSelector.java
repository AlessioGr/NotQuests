...
public class ActiveQuestSelector<C> extends CommandArgument<C, ActiveQuest> {
    ...
    public static @NonNull <C> Builder<C> newBuilder(final @NonNull String name, final NotQuests main, final String playerContext) {
        return new Builder<>(name, main, playerContext);
    }
