package rocks.gravili.notquestsspigot;
...
import rocks.gravili.notquestsspigot.conversation.ConversationEvents;
import rocks.gravili.notquestsspigot.conversation.ConversationManager;
import rocks.gravili.notquestsspigot.events.ArmorStandEvents;
import rocks.gravili.notquestsspigot.events.InventoryEvents;
import rocks.gravili.notquestsspigot.events.QuestEvents;
import rocks.gravili.notquestsspigot.events.TriggerEvents;
import rocks.gravili.notquestsspigot.events.notquests.other.PlayerJumpEvent;
import rocks.gravili.notquestsspigot.managers.*;
import rocks.gravili.notquestsspigot.managers.packets.PacketManager;
import rocks.gravili.notquestsspigot.managers.registering.ActionManager;
import rocks.gravili.notquestsspigot.managers.registering.ConditionsManager;
import rocks.gravili.notquestsspigot.managers.registering.ObjectiveManager;
import rocks.gravili.notquestsspigot.managers.registering.TriggerManager;
...
import rocks.gravili.notquestsspigot.structs.triggers.Trigger;
